...
public:
	...
	void processInput(IDEvent a_eventID, ConsoleRE::INPUT_DEVICE a_device);
...
private:
	using animEventMap = std::unordered_map<IDEvent, std::shared_ptr<std::vector<ConsoleRE::BSFixedString>>>;
